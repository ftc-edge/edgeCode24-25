...
public class ProjectionPosition {
    ...
    public ProjectionPosition(double _x, double _y){
        this.x = _x;
        this.y = _y;
    }

    public ProjectionPosition(double _xPixel, double _yPixel, double _cameraWidthCM, double _cameraHeightCM, double _cameraWidthPx, double _cameraHeightPx){
